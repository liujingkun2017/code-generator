...
import org.liujk.code.generator.seventhcensus.config.GeneratorStrategy;
...
public class SpringBootPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("minapp-preqrcode")
                .setParentPackage("com.uxsino")
//                .setModuleName("")
                .setAuthor("yky")
                .setFileOverride(false);

        // 设置表信息
        generatorProperties.addTable("stat_qrcode","random_code");
        // 设置表前缀
        ...
        generatorProperties.getDataSourceConfig()
                ...
                .setUrl("jdbc:mysql://10.0.12.126:15006/seventh_census_gather_rpx7?characterEncoding=UTF-8&useSSL=false");
