        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="password">
              <a-input placeholder="请输入password" v-model="queryParam.password"></a-input>
            </a-form-item>
          </a-col>
        <template v-if="toggleSearchStatus">
        <a-col :md="6" :sm="8">
            <a-form-item label="realname">
              <a-input placeholder="请输入realname" v-model="queryParam.realname"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="age">
              <a-input placeholder="请输入age" v-model="queryParam.age"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="gender">
              <a-input placeholder="请输入gender" v-model="queryParam.gender"></a-input>
            </a-form-item>
          </a-col>
        </template>
          <a-col :md="6" :sm="8" >
